...
plugins=(cp fd fzf git sudo zoxide zsh-autosuggestions)
...
alias re='ranger'
alias hx='helix'
alias act='autocorrect'
alias wh='whereis'
alias setproxy='export http_proxy="http://192.168.176.1:10811" && export https_proxy="http://192.168.176.1:10811"'
